    ...
    render() {
        return (<Segment basic vertical>
                ...
                <Header>Views</Header>
                    ...
                    <Grid.Column>
                        <Header sub><Icon name="block layout" circular style={{ marginRight: 0 }} /><Header.Content>Create a View </Header.Content></Header>
                    ...
                    <Grid.Column>
                        <Header sub><Icon name="block layout" circular style={{ marginRight: 0 }} /><Header.Content>View a Demo </Header.Content></Header>
                        <p>A view is a user interface mapped over a collection of devices or tests. Views give you quick insights and control over a test station, workspace, or entire lab.</p>
                    </Grid.Column>
                     </Grid.Row>
                     <Grid.Row>
